...
public class ListPicker extends LinearLayout {
    ...
    public ListPicker(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.listPickerStyle);
    }

    public ListPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);

        // process style attributes
        TypedArray attributesArray = context.obtainStyledAttributes(
                attrs, R.styleable.ListPicker, defStyle, 0);
        final int layoutResId = attributesArray.getResourceId(
                R.styleable.ListPicker_internalLayout, DEFAULT_LAYOUT_RESOURCE_ID);

        mHasSelectorWheel = (layoutResId != DEFAULT_LAYOUT_RESOURCE_ID);

        mSolidColor = attributesArray.getColor(R.styleable.ListPicker_solidColor, 0);

        mSelectionDivider = attributesArray.getDrawable(R.styleable.ListPicker_selectionDivider);
        ...
        mSelectionDividerHeight = attributesArray.getDimensionPixelSize(
                R.styleable.ListPicker_selectionDividerHeight, defSelectionDividerHeight);
        ...
        mSelectionDividersDistance = attributesArray.getDimensionPixelSize(
                R.styleable.ListPicker_selectionDividersDistance, defSelectionDividerDistance);

        mMinHeight = attributesArray.getDimensionPixelSize(
                R.styleable.ListPicker_internalMinHeight, SIZE_UNSPECIFIED);

        mMaxHeight = attributesArray.getDimensionPixelSize(
                R.styleable.ListPicker_internalMaxHeight, SIZE_UNSPECIFIED);
        ...
        mMinWidth = attributesArray.getDimensionPixelSize(
                R.styleable.ListPicker_internalMinWidth, SIZE_UNSPECIFIED);

        mMaxWidth = attributesArray.getDimensionPixelSize(
                R.styleable.ListPicker_internalMaxWidth, SIZE_UNSPECIFIED);
        ...
        mVirtualButtonPressedDrawable = attributesArray.getDrawable(
                R.styleable.ListPicker_virtualButtonPressedDrawable);
     ...
     * <p>
     * If the argument is less than the {@link ListPicker#getMinValue()} and
     * {@link ListPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link ListPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link ListPicker#getMinValue()} and
     * {@link ListPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link ListPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link ListPicker#getMaxValue()} and
     * {@link ListPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link ListPicker#getMaxValue()} value.
     * </p>
     * <p>
     ...
     * wrap around the {@link ListPicker#getMinValue()} and
     * {@link ListPicker#getMaxValue()} values.
     * <p>
    ...
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();removeAllCallbacks();
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(ListPicker.class.getName());
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            ListPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            ListPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                ListPicker.this.postDelayed(this,
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (ListPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (ListPicker.this.isEnabled()) {
                                ListPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (ListPicker.this.isEnabled()) {
                                ...
                                ListPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(ListPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(ListPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(ListPicker.this.isEnabled());
                event.setSource(ListPicker.this, virtualViewId);
                requestSendAccessibilityEvent(ListPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(ListPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(ListPicker.this, virtualViewId);
            info.setParent(ListPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(ListPicker.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(ListPicker.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(ListPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(ListPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(ListPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(ListPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
        ...
        private String getVirtualDecrementButtonText() {
            ...
            if (value >= mMinValue) {
                return (mDisplayedValues == null) ? formatNumberWithLocale(value)
