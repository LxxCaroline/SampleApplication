...
/**
 * Created by caroline on 2015-07-30.
 */
public class ToolbarFAB extends RelativeLayout {
    // anim timing
    //
    ...
    public ToolbarFAB(Context context) {
        super(context);
    }

    public ToolbarFAB(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttrs(attrs);
    }

    public ToolbarFAB(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        parseAttrs(attrs);
    }

    private void parseAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ToolbarFAB);

        SHOW_ANIM_DURATION = a.getInt(R.styleable.ToolbarFAB_showDuration, SHOW_ANIM_DURATION);
        HIDE_ANIM_DURATION = a.getInt(R.styleable.ToolbarFAB_hideDuration, HIDE_ANIM_DURATION);
        BOTTOM_MARGIN = a.getDimensionPixelSize(R.styleable.ToolbarFAB_bottomMargin, BOTTOM_MARGIN);
        RIGHT_MARGIN = a.getDimensionPixelSize(R.styleable.ToolbarFAB_rightMargin, RIGHT_MARGIN);
        pivotX = a.getDimensionPixelSize(R.styleable.ToolbarFAB_fadeInPivotX, -1);
        pivotY = a.getDimensionPixelSize(R.styleable.ToolbarFAB_fadeInPivotY, -1);
        fraction = a.getFloat(R.styleable.ToolbarFAB_fadeInFraction, fraction);
        fabId = a.getResourceId(R.styleable.ToolbarFAB_fabId, -1);
        containerId = a.getResourceId(R.styleable.ToolbarFAB_containerId, -1);
        toolbarId = a.getResourceId(R.styleable.ToolbarFAB_fabToolbarId, -1);
        fabDrawableAnimationEnabled = a.getBoolean(R.styleable.ToolbarFAB_fabDrawableAnimationEnabled, true);
        ...
        toolbarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                if (toolbarLayout.getWidth() != 0 || toolbarLayout.getHeight() != 0) {
                    ...
                    LayoutParams layoutParams = (LayoutParams) fabContainer.getLayoutParams();
